...
if 1:
    ...
    # 数据集。
    desc += '-berea128';dataset = EasyDict(tfrecord_dir='berea', resolution=128)

    # GPU数量。
    desc += '-2gpu';
    submit_config.num_gpus = 2;sched.minibatch_base = 4;sched.minibatch_dict = {4: 256, 8: 128, 16: 64, 32: 32, 64: 16, 128: 8}

    # 默认设置。
    train.total_kimg = 500
    sched.lod_initial_resolution = 4
    sched.G_lrate_dict = {4: 0.002, 8: 0.002, 16: 0.002, 32: 0.002, 64: 0.002, 128: 0.002}
